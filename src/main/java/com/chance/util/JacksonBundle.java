...
public class JacksonBundle {
    ...
    /**
     * 构造方法，根据Jackson的{@link JsonInclude.Include}类创建ObjectMapper
     */
    public JacksonBundle(JsonInclude.Include include) {
    ...
    public static JacksonBundle nonEmptyMapper() {
        ...
        return new JacksonBundle(JsonInclude.Include.NON_EMPTY);
    }
    ...
    public static JacksonBundle alwaysMapper() {
        return new JacksonBundle(JsonInclude.Include.ALWAYS);
    }
    ...
    public static JacksonBundle nonNullMapper() {
        return new JacksonBundle(JsonInclude.Include.NON_NULL);
    }
    ...
    public static JacksonBundle nonDefaultMapper() {
        return new JacksonBundle(JsonInclude.Include.NON_DEFAULT);
    }
